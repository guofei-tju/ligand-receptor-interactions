 function [Predict_label_f,Score_f,SMR_test_label]=bootstrap_FCM_RF_n(data,P_L_test_feature,P_L_test_label,P_L_train_feature,P_L_train_label,k,nTree,Num_share)
%FCM Clustering
...
for j=1:Num_share
    ...
    eval(['[Predict_label_f' num2str(j) ',Predict_score_f' num2str(j) ']=predict(model' num2str(j) ',SMR_test_feature);']);
